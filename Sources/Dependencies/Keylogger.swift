...
@objc public class KeyloggerEvent: NSObject {
    ...
    public let base: NSEvent
    public let target: Target

    public var keyCode: KeyCode? {
        return .init(rawValue: base.keyCode)
    }
    ...
    public var isCommandKeyPressed: Bool {
        base.modifierFlags.contains(.command)
    }

    public var isShiftKeyPressed: Bool {
        base.modifierFlags.contains(.shift)
    }

    public var isControlKeyPressed: Bool {
        base.modifierFlags.contains(.control)
    }

    public var isOptionKeyPressed: Bool {
        base.modifierFlags.contains(.option)
    }


    public init(event: NSEvent, target: Target) {
        base = event
        self.target = target
    }
}
